export default class Jogador {
    ...
    public treinarAtacar(): void {
        this._ataque += this.randomizar(8);
    ...
    public treinarPrecisao(): void {
        this._precisao += this.randomizar(9);
    ...
    public chanceArremesso(): number {
        let chanceArremesso: number = this.randomizar(10);
        this._precisao -= chanceArremesso;
        return chanceArremesso;
    }
